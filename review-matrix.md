...
| Real frontend integration | corrected address, source-grounded defaults, visible wallet errors, all public methods, creator and source-limit UI, rollback-aware polling | 11 frontend tests and production build | PASS |
...
| Public production wallet write path | create from the public site with fresh browser inputs | reached wallet connection on the public build; verification browser has no injected wallet provider | UNVERIFIED |
